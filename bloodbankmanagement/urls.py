...
urlpatterns = [
    ...
    path('admin-statistics', views.admin_statistics_view, name='admin-statistics'),
    ...
    path('update-approve-status/<int:pk>/<int:units>', views.update_approve_status_view,name='update-approve-status'),
